            ...
            <div class="col-md-12 d-flex align-items-center justify-content-between">
                ...
                <div class="dropdown user-menu">
				    ...
				    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
				        <li><a class="dropdown-item" href="update-info.php"><i class="fa fa-pencil"></i> Update Info</a></li>
				        <li><a class="dropdown-item" href="change-password.php"><i class="fa fa-key"></i> Change Password</a></li>
